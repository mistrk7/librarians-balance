...
data merge storage libal:books {blacklist:{1:"minecraft:x",2:"minecraft:x",3:"minecraft:x",4:"minecraft:x",5:"minecraft:x",6:"minecraft:x"}}
...
data merge storage libal:books {delisted:{1:"minecraft:mending",2:"minecraft:x",3:"minecraft:x",4:"minecraft:x",5:"minecraft:x",6:"minecraft:x"}}
# Replace the "x" with your enchant name: ex. silk_touch. You cannot add more than six.
