...
$execute if score book_illegal libal.main matches 0 run execute store success score book_illegal libal.main run data get entity @s SelectedItem.components."minecraft:stored_enchantments".levels.$(4)
