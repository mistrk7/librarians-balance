...
$execute if score book_illegal libal.main matches 0 run execute store success score book_illegal libal.main run data get entity @s equipment.legs.components."minecraft:stored_enchantments".$(1)
