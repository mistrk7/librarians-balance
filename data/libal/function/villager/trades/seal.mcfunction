...
execute if score isSeal libal.main matches 1 run execute if data entity @s Offers.Recipes[1].buyB{id:"minecraft:book"} run data modify entity @s Offers.Recipes[1].sell.components merge value {"minecraft:stored_enchantments":{"libal:sealed":1}}
