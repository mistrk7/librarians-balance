...
$execute if data entity @s[tag=!trader] Offers.Recipes[0].sell.components."minecraft:stored_enchantments".$(5) run data modify entity @s Offers.Recipes[0].sell.components."minecraft:stored_enchantments" set from storage libal:books replacements[0]
$execute if data entity @s[tag=!trader] Offers.Recipes[0].sell.components."minecraft:stored_enchantments".$(6) run data modify entity @s Offers.Recipes[0].sell.components."minecraft:stored_enchantments" set from storage libal:books replacements[0]
...
$execute if data entity @s[tag=!trader] Offers.Recipes[1].sell.components."minecraft:stored_enchantments".$(5) run data modify entity @s Offers.Recipes[1].sell.components."minecraft:stored_enchantments" set from storage libal:books replacements[0]
$execute if data entity @s[tag=!trader] Offers.Recipes[1].sell.components."minecraft:stored_enchantments".$(6) run data modify entity @s Offers.Recipes[1].sell.components."minecraft:stored_enchantments" set from storage libal:books replacements[0]
...
$execute if data entity @s Offers.Recipes[2].sell.components."minecraft:stored_enchantments".$(5) run data modify entity @s Offers.Recipes[2].sell.components."minecraft:stored_enchantments" set from storage libal:books replacements[1]
$execute if data entity @s Offers.Recipes[2].sell.components."minecraft:stored_enchantments".$(6) run data modify entity @s Offers.Recipes[2].sell.components."minecraft:stored_enchantments" set from storage libal:books replacements[1]
...
$execute if data entity @s Offers.Recipes[3].sell.components."minecraft:stored_enchantments".$(5) run data modify entity @s Offers.Recipes[3].sell.components."minecraft:stored_enchantments" set from storage libal:books replacements[2]
$execute if data entity @s Offers.Recipes[3].sell.components."minecraft:stored_enchantments".$(6) run data modify entity @s Offers.Recipes[3].sell.components."minecraft:stored_enchantments" set from storage libal:books replacements[2]

#Slot 4
$execute if data entity @s Offers.Recipes[4].sell.components."minecraft:stored_enchantments".$(1) run data modify entity @s Offers.Recipes[4].sell.components."minecraft:stored_enchantments" set from storage libal:books replacements[0]
...
$execute if data entity @s Offers.Recipes[4].sell.components."minecraft:stored_enchantments".$(5) run data modify entity @s Offers.Recipes[4].sell.components."minecraft:stored_enchantments" set from storage libal:books replacements[0]
$execute if data entity @s Offers.Recipes[4].sell.components."minecraft:stored_enchantments".$(6) run data modify entity @s Offers.Recipes[4].sell.components."minecraft:stored_enchantments" set from storage libal:books replacements[0]
...
$execute if data entity @s Offers.Recipes[5].sell.components."minecraft:stored_enchantments".$(5) run data modify entity @s Offers.Recipes[5].sell.components."minecraft:stored_enchantments" set from storage libal:books replacements[1]
$execute if data entity @s Offers.Recipes[5].sell.components."minecraft:stored_enchantments".$(6) run data modify entity @s Offers.Recipes[5].sell.components."minecraft:stored_enchantments" set from storage libal:books replacements[1]
...
$execute if data entity @s Offers.Recipes[6].sell.components."minecraft:stored_enchantments".$(5) run data modify entity @s Offers.Recipes[6].sell.components."minecraft:stored_enchantments" set from storage libal:books replacements[2]
$execute if data entity @s Offers.Recipes[6].sell.components."minecraft:stored_enchantments".$(6) run data modify entity @s Offers.Recipes[6].sell.components."minecraft:stored_enchantments" set from storage libal:books replacements[2]
...
$execute if data entity @s Offers.Recipes[7].sell.components."minecraft:stored_enchantments".$(5) run data modify entity @s Offers.Recipes[7].sell.components."minecraft:stored_enchantments" set from storage libal:books replacements[0]
$execute if data entity @s Offers.Recipes[7].sell.components."minecraft:stored_enchantments".$(6) run data modify entity @s Offers.Recipes[7].sell.components."minecraft:stored_enchantments" set from storage libal:books replacements[0]