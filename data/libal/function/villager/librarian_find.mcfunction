...
$execute as @e[type=villager,nbt={Brain:{memories:{"minecraft:job_site":{value:{pos:$(cord)}}}}}] run execute if score condition libal.main matches 1 run function libal:villager/librarian_travel with storage libal:jobs_find
