...
execute unless score book_vanilla libal.main matches 1 run title @p[sort=nearest, limit=1] actionbar {"text":"This book is too complex.","color":"red"}
execute unless score book_vanilla libal.main matches 1 run execute positioned ~ ~ ~ run playsound block.chiseled_bookshelf.pickup.enchanted block @a ~ ~ ~ 0.5
execute unless score book_vanilla libal.main matches 1 run execute positioned ~ ~ ~ run playsound entity.villager.work_cartographer block @a ~ ~ ~ 0.1
