...
#How many items in a stack
scoreboard players set stack libal.main 9
#Set the cost isn't in blocks (for now)
...
## Overwrite the price if there is a special book.
# TIER 4 - 24 Emeralds (mostly sealed books). By design, two stacked sealed books should equal to the price of a level 5 book. 
...
# TIER 3 - 36 Emeralds (like a level 4 book)
...
# TIER 2 - 48 Emeralds (like a level 5 book)
...
execute if score price libal.main > threshold libal.main run scoreboard players operation price libal.main /= stack libal.main
...
scoreboard players reset stack libal.main
