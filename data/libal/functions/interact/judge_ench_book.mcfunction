...
execute if score illegal libal.main matches 1 run execute store success score illegal libal.main run data modify storage libal:books blacklist[0] set from block ~ ~ ~ Book.tag.StoredEnchantments[0].id
execute if score illegal libal.main matches 1 run execute store success score illegal libal.main run data modify storage libal:books blacklist[1] set from block ~ ~ ~ Book.tag.StoredEnchantments[0].id
execute if score illegal libal.main matches 1 run execute store success score illegal libal.main run data modify storage libal:books blacklist[2] set from block ~ ~ ~ Book.tag.StoredEnchantments[0].id
execute if score illegal libal.main matches 1 run execute store success score illegal libal.main run data modify storage libal:books blacklist[3] set from block ~ ~ ~ Book.tag.StoredEnchantments[0].id
