...
execute if score isSeal libal.main matches 1 run execute if data entity @s Offers.Recipes[0].buyB{count:1} run data modify entity @s Offers.Recipes[0].sell.components merge value {"minecraft:custom_data":{sealed:True},"minecraft:lore":['{"text":" Sealed","color":"blue"}']}
execute if score isSeal libal.main matches 1 run execute if data entity @s Offers.Recipes[1].buyB{count:1} run data modify entity @s Offers.Recipes[1].sell.components merge value {"minecraft:custom_data":{sealed:True},"minecraft:lore":['{"text":" Sealed","color":"blue"}']}
