...
execute if data entity @s Offers.Recipes[1].buyB{count:1} run data modify entity @s Offers.Recipes[1].sell set from entity @s ArmorItems[0].components."minecraft:custom_data".Storage[0]
execute if data entity @s Offers.Recipes[0].buyB{count:1} run data modify entity @s Offers.Recipes[0].sell set from entity @s ArmorItems[0].components."minecraft:custom_data".Storage[0]
